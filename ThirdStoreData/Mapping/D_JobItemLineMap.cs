...
{
    public class D_JobItemLineMap : EntityTypeConfiguration<D_JobItemLine>
    {
        public D_JobItemLineMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.Property(t => t.IsOrginalPackage).HasColumnName("IsOrginalPackage");
