...
{
    public class ThirdStoreRepository<T>:IRepository<T> where T:BaseEntity
    {
        ...
        public ThirdStoreRepository(IDbContext context)
        {
            this._context = context;
        }

        //public NewAimWebRepository(DBSource source)
        //{
        //    this._context = (IDbContext)(source == DBSource.CS ? new NewAimWebDbContext() : new NewAimWebWMSDbContext());
        //}
