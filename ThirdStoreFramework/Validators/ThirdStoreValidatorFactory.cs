...
namespace ThirdStoreFramework.Validators
{
    public class ThirdStoreValidatorFactory : AttributedValidatorFactory
    {
        ...
        public override IValidator GetValidator(Type type)
        {
            if (type != null)
            {
                ...
                if ((attribute != null) && (attribute.ValidatorType != null))
                {
                    ...
                    var instance = ThirdStoreCommon.Infrastructure.ThirdStoreWebContext.Instance.ResolveUnregistered(attribute.ValidatorType);
